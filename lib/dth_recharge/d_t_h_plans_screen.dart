...
import 'package:recharge_retry/dth_recharge/dth_payment_screen.dart';
...
class _DTHPlansScreenState extends State<DTHPlansScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(plan.name+" "+" Plans",style: TextStyle(fontSize: 14,color: Colors.white),),
                ...
                return ListTile(
                  ...
                  onTap: () {
                    ...
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(builder: (context) => DthPaymentScreen(plan,cardnumber,mobilenumber,  amount.toString(),amount1.toString(),paymentmode)),
                    );
                  },
                );
              },
  ...
  getDTHPlans(String type)async{
    ...
    String urldata="https://mysaveapp.com/easyrecharge/newrecharge/DTHplans.php?timestamp="+DateTime.now().microsecondsSinceEpoch.toString()+"&operatorcode="+plan.opcode+"&type="+type;
    ...
    PackListEntity packListEntity=PackListEntity.fromJson(jsonDecode(response));

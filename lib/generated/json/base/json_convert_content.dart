...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<ProtrackerNotInvoiceEntity>[] is M) {
      return data.map<ProtrackerNotInvoiceEntity>((Map<String, dynamic> e) =>
          ProtrackerNotInvoiceEntity.fromJson(e)).toList() as M;
    }
    if (<ProtrackerNotInvoiceData>[] is M) {
      return data.map<ProtrackerNotInvoiceData>((Map<String, dynamic> e) =>
          ProtrackerNotInvoiceData.fromJson(e)).toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    (ProtrackerNotInvoiceEntity).toString(): ProtrackerNotInvoiceEntity
        .fromJson,

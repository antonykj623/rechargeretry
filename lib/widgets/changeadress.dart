...
class AddressChangeScreen extends StatefulWidget {
  ...
  AddressChangeScreen(this.userid,this.addressid) ;

  @override
  _AddressChangeScreenState createState() => _AddressChangeScreenState(this.userid,this.addressid) ;
}
...
class _AddressChangeScreenState extends State<AddressChangeScreen> {
  ...
  _AddressChangeScreenState(this.userid,this.addressid) ;
  ...
  getAddress()async
  {
    ...
    String response=await apiHelper.getApiResponse(ApiMethodeCredentials.ecommerce_baseurl+ApiMethodeCredentials.getAddressByidoffice+"?timestamp="+apiHelper.getRandomnumber()+"&id="+addressid);

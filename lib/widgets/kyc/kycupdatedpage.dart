...
class KYCUpdatedPage extends StatefulWidget {
  const KYCUpdatedPage({Key? key}) : super(key: key);

  @override
  State<KYCUpdatedPage> createState() => _KYCApprovedPageState();
}

class _KYCApprovedPageState extends State<KYCUpdatedPage> {
  ...
  Future<void> fetchKYC() async {
    ...
    String url =
        "https://mysaving.in/IntegraAccount/api/getKYCdataByUpdatedDate.php"
